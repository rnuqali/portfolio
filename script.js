...
const translations = {
  en: {
    ...
    aboutTitle: "Building technology that solves real problems.",
    aboutText1:
    ...
    skillsTitle: "Skills",
    skillsProgramming: "Programming & Web",
    skillsAI: "AI & Data",
    skillsSystems: "Systems & Tools",
    ...
    educationDetails:
      "GPA 3.58/4.00 · Graduated with Honors",
    ...
    footerText: "Designed & built with care."
  },
  ...
  ar: {
    ...
    heroTitle1: "خريجة علوم حاسب",
    heroTitle2: "مهتمة بالذكاء الاصطناعي وتحليل البيانات",
    heroText:
    ...
    aboutTitle: "أبني حلولًا تقنية لمشكلات حقيقية.",
    aboutText1:
      "خريجة علوم حاسب من جامعة أم القرى، ولدي خبرة عملية في تطوير البرمجيات، والدعم التقني، والأنظمة المدعومة بالذكاء الاصطناعي من خلال التدريب والمشاريع الأكاديمية.",
    aboutText2:
    ...
    nlpTitle:
      "تحليل المشاعر باستخدام نماذج Transformers",
    nlpText:
    ...
    ckdText:
      "مشروع تعلم آلة لتصنيف حالات مرض الكلى المزمن باستخدام Logistic Regression وNaïve Bayes، مع تقييم ROC/AUC ومصفوفات الالتباس وK-Means وPCA وتجربة تنبؤ تفاعلية.",
    ...
    liveDemo: "تجربة المشروع ↗",
    viewNotebook: "عرض الـNotebook ↗",
    viewCode: "عرض الكود ↗",
    projectShowcase: "عرض المشروع",

    skillsEyebrow: "الأدوات والتقنيات",
    skillsTitle: "المهارات",
    skillsProgramming: "البرمجة وتطوير الويب",
    skillsAI: "الذكاء الاصطناعي والبيانات",
    skillsSystems: "الأنظمة والأدوات",
    skillsProfessional: "المهارات المهنية",

    background: "المسار الأكاديمي والمهني",
    ...
    educationDetails:
      "المعدل 3.58 من 4.00 · التخرج بمرتبة الشرف",

    internTitle: "متدربة تقنية معلومات",
    hospital:
    ...
    contactEyebrow: "لنتواصل",
    contactTitle: "هل لديك فرصة مناسبة؟",
    contactText:
      "مهتمة بالفرص في مجالات الذكاء الاصطناعي، وتحليل البيانات، والبرمجيات، والتقنية.",

    footerText: "تم التصميم والتطوير بعناية."
  }
};
